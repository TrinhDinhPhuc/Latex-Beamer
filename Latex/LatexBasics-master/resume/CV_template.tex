...
\halfblankline
\textbf{\href{http://cbdrobot.com/}{\textbf{ CBD Robotics}} (Part time intern)}  \textit{03/2018 -}
    \begin{outerlist}
        \item Position: {Machine Learning Engineer intern}
        \item Address: {125 Dong Van Cong Str. District 2, Ho Chi Minh City, Vietnam}
    \end{outerlist}
\halfblankline
...
\begin{outerlist}
  ...
  \item {\it Technical Softwares}: Cisco packet tracer, MongoDB, Postgresql, Visual Studio, SQL Server, Navicat, Eclipse, NetBeans.
  	\item {\it Operating System}: Linux Window. 
...
\vspace{-0.25in}
\begin{outerlist}
\item \textbf{\textit{Academic}} Research in digital signal/image processing algorithms, exploration in data analysis, machine learning, and big data. 
\item \textbf{\textit{Social}} Reading books, swimming, traveling, playing guitar, blog writing on Personal Blog.
\end{outerlist}
